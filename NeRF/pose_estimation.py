...
intrinsic_param = np.matrix([[focal_length, 0, 640], [0, focal_length, 360], [0, 0, 1]])

images = os.listdir("/home/dzc/Data/MultiviewC2Nerf/images/")

imgs = []

for image in images:
    img = cv2.imread("/home/dzc/Data/MultiviewC2Nerf/images/" + image)
