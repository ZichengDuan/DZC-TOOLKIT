...
if __name__ == "__main__":
    ...
    parser.add_argument("--annofile", default="/home/dzc/Desktop/Desktop/CASIA/proj/darknet/data/myCOCOdata/coco_bev_perspective_binary.json",
            help = "The file which contains all the annotations for a dataset in json format.")
    parser.add_argument("--out-dir", default = "/home/dzc/Data/opensource/labels",
            help = "The output directory where we store the annotation per image.")
    parser.add_argument("--imgset-file", default = 0,
